...
### [test_01_pools.py](test_01_pools.py) · [description](../aio%20test%20description/test_01_pools.md) — IP Pool CRUD + Stats
...
### [test_01b_radius_warmup.py](test_01b_radius_warmup.py) · [description](../aio%20test%20description/test_01b_radius_warmup.md) — RADIUS Warmup
...
### [test_01c_routing_domains.py](test_01c_routing_domains.py) · [description](../aio%20test%20description/test_01c_routing_domains.md) — Routing Domain CRUD + suggest-cidr
...
### [test_01d_free_cidr_finder.py](test_01d_free_cidr_finder.py) · [description](../aio%20test%20description/test_01d_free_cidr_finder.md) — Free CIDR Finder
...
### [test_02_range_configs.py](test_02_range_configs.py) · [description](../aio%20test%20description/test_02_range_configs.md) — IMSI Range Config CRUD
...
### [test_03_iccid_profile.py](test_03_iccid_profile.py) · [description](../aio%20test%20description/test_03_iccid_profile.md) — `ip_resolution = "iccid"`
...
### [test_04_imsi_profile.py](test_04_imsi_profile.py) · [description](../aio%20test%20description/test_04_imsi_profile.md) — `ip_resolution = "imsi"`
...
### [test_05_imsi_apn_profile.py](test_05_imsi_apn_profile.py) · [description](../aio%20test%20description/test_05_imsi_apn_profile.md) — `ip_resolution = "imsi_apn"`
...
### [test_06_imsi_ops.py](test_06_imsi_ops.py) · [description](../aio%20test%20description/test_06_imsi_ops.md) — IMSI Add / Remove
...
### [test_07_dynamic_alloc.py](test_07_dynamic_alloc.py) · [description](../aio%20test%20description/test_07_dynamic_alloc.md) — First-Connection Allocation (Single-IMSI Baseline)
...
### [test_07b_dynamic_alloc_modes.py](test_07b_dynamic_alloc_modes.py) · [description](../aio%20test%20description/test_07b_dynamic_alloc_modes.md) — First-Connection All Allocation Modes
...
### [test_07c_release_ips.py](test_07c_release_ips.py) · [description](../aio%20test%20description/test_07c_release_ips.md) — IP Release & IMSI Detach
...
### [test_07e_release_reconnect_all_modes.py](test_07e_release_reconnect_all_modes.py) · [description](../aio%20test%20description/test_07e_release_reconnect_all_modes.md) — Release + Re-allocate (All Modes)
...
### [test_08_iccid_apn_profile.py](test_08_iccid_apn_profile.py) · [description](../aio%20test%20description/test_08_iccid_apn_profile.md) — `ip_resolution = "iccid_apn"`
...
### [test_09_migration.py](test_09_migration.py) · [description](../aio%20test%20description/test_09_migration.md) — Migration Validation
...
### [test_10_errors.py](test_10_errors.py) · [description](../aio%20test%20description/test_10_errors.md) — Validation & Error Handling
...
### [test_11_performance.py](test_11_performance.py) · [description](../aio%20test%20description/test_11_performance.md) — Latency Under Load
...
### [test_12_radius.py](test_12_radius.py) · [description](../aio%20test%20description/test_12_radius.md) — End-to-End RADIUS (imsi mode)
...
### [test_12_grafana_metrics.py](test_12_grafana_metrics.py) · [description](../aio%20test%20description/test_12_grafana_metrics.md) — Grafana Dashboard Metric Presence
...
### [test_12b_radius_modes.py](test_12b_radius_modes.py) · [description](../aio%20test%20description/test_12b_radius_modes.md) — RADIUS End-to-End (All 4 ip_resolution Modes)
...
### [test_13_export_and_ip_search.py](test_13_export_and_ip_search.py) · [description](../aio%20test%20description/test_13_export_and_ip_search.md) — Export CSV + IP Filter + Terminated SIM Visibility
...
### [test_14_export_delete_reprovision.py](test_14_export_delete_reprovision.py) · [description](../aio%20test%20description/test_14_export_delete_reprovision.md) — Export → Delete → Bulk Re-import
...
### [test_15_bulk.py](test_15_bulk.py) · [description](../aio%20test%20description/test_15_bulk.md) — Bulk Upsert
...
### [test_15b_bulk_actions.py](test_15b_bulk_actions.py) · [description](../aio%20test%20description/test_15b_bulk_actions.md) — Bulk IP Release + Bulk IMSI Delete
...
### [test_16_lookup_fast_path.py](test_16_lookup_fast_path.py) · [description](../aio%20test%20description/test_16_lookup_fast_path.md) — Lookup Fast-Path & Cross-Mode Suspend
...
### [test_17_immediate_provisioning.py](test_17_immediate_provisioning.py) · [description](../aio%20test%20description/test_17_immediate_provisioning.md) — Immediate Provisioning Mode
...
### [test_18_nullable_slot_pool.py](test_18_nullable_slot_pool.py) · [description](../aio%20test%20description/test_18_nullable_slot_pool.md) — Nullable Slot pool_id + Per-Slot APN Pool Routing
...
### [test_19_validation_and_mgmt.py](test_19_validation_and_mgmt.py) · [description](../aio%20test%20description/test_19_validation_and_mgmt.md) — ICCID Range Config Validation & Management
...
### [test_20_imsi_only_immediate.py](test_20_imsi_only_immediate.py) · [description](../aio%20test%20description/test_20_imsi_only_immediate.md) — IMSI-Only SIM Groups: Immediate Bulk Provisioning
...
### [test_21_imsi_only_first_connect.py](test_21_imsi_only_first_connect.py) · [description](../aio%20test%20description/test_21_imsi_only_first_connect.md) — IMSI-Only SIM Groups: First-Connect Provisioning
